      ...
      case SLIDE_OBJECT_TYPES.placeholder:
        ...
        if (slideItemObj.options.line.isConnector) {
          ...
          if (slideItemObj.options.line.sourceId != null) {
            sourceId = slide._slideObjects.findIndex(d => d.options.sId === slideItemObj.options.line.sourceId)
            sourceId = sourceId + 2
          }
          if (slideItemObj.options.line.targetId != null) {
            targetId = slide._slideObjects.findIndex((d) => d.options.sId === slideItemObj.options.line.targetId)
            targetId = targetId + 2
          }
          // A: Start Connector =======================================================
          strSlideXml += '<p:cxnSp>';
